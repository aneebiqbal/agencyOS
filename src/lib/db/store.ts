...
function createInitialState(): MutableState {
  ...
  return {
    ...
    projectMembers: [
      { projectId: "project-test-1", userId: "manager-1" },
      { projectId: "project-test-1", userId: "employee-1" },
    ],
    timeEntries: [],
    expenses: [],
    invoices: [],
    ...
    employees: [
      { userId: "owner-1", role: "owner", managerUserId: null, payrollProviderRef: "prov-owner-1" },
      {
        ...
        payrollProviderRef: "prov-finance-1",
      },
      {
        userId: "manager-1",
        role: "manager",
        managerUserId: "owner-1",
        payrollProviderRef: "prov-manager-1",
      },
      {
        userId: "employee-1",
        role: "employee",
        managerUserId: "manager-1",
        payrollProviderRef: "prov-employee-1",
      },
      {
        userId: "employee-2",
        role: "employee",
        managerUserId: "manager-1",
        payrollProviderRef: "prov-employee-2",
      },
    ],
    idempotencyByKey: {},
  };
